...
export function login () {
  ...
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    const query = "SELECT * FROM Users WHERE email = '" + email + "' AND password = '" + security.hash(password) + "' AND deletedAt IS NULL"
    models.sequelize.query(query, { model: UserModel, plain: true }) // vuln-code-snippet vuln-line loginAdminChallenge loginBenderChallenge loginJimChallenge
